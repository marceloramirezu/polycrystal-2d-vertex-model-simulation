...
def generate_voronoi(
        ...
        seed, 
        dist=-1,
        file_vertices=f"{path}/salida/vertices.txt", 
        file_ridges=f"{path}/salida/borders.txt",
        file_orientations=f"{path}/salida/orientations.txt",
        file_SE=f"{path}/salida/se.txt"
):
